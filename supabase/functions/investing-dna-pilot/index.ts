...
const EVENT_NAMES = new Set([
  ...
  'workspace_viewed','workspace_resume_clicked','auth_callback_session_established','account_state_restored',
  'feedback_submitted'
]);
...
function cleanMetadata(value: unknown) {
  ...
  const allowed = new Set(['source','status','cohort_code','questionnaire_version','model_version','fit_status','selected_count','mode','returning','target','new_market_data_count','match_updated','has_dna','has_context','watchlist_count']);
