...
begin
 ...
 select z.id,
 case when z.identity_complete and z.metrics_complete and z.risk_complete and z.price_history_complete and z.holdings_complete and z.source_complete then 'verified'
      when z.identity_complete and z.source_complete and (z.metrics_complete or z.risk_complete or z.price_history_complete or z.holdings_complete) then 'verified_partial'
      when z.latest_metric_date is not null and z.latest_metric_date < current_date - 30 then 'stale'
      else 'incomplete' end,
 ...
 z.missing_fields, z.quality_score, 'Automated Data Quality Check'
 from (
  select i.id,
