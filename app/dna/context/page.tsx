...
function ContextShell({children}:{children:React.ReactNode}){return <main className="context-page"><div className="container context-container"><div className="context-experience-shell"><div className="context-experience-content">{children}</div><aside className="context-experience-art approved-illustration-panel" aria-hidden="true"><img src="/illustrations/your-money-context.webp" alt="" className="approved-side-illustration"/></aside></div></div></main>}
