...
function ContextShell({children}:{children:React.ReactNode}){return <main className="context-page"><div className="container context-container"><div className="context-experience-shell"><div className="context-experience-content">{children}</div><aside className="context-experience-art" aria-hidden="true"><span className="scene-sun"/><span className="scene-ridge"/><span className="scene-ridge front"/><span className="scene-path"/><span className="scene-sign">SAME VALUES<br/>NEW HORIZONS</span></aside></div></div></main>}
