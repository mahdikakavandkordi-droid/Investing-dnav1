...
export default function Home(){
  ...
  if(screen==="landing") return <main className={`home-shell ${language==="fa"?"rtl":""}`}>
    ...
    <section className="home-hero">
      ...
      <div className="home-visual" aria-hidden="true">
        ...
        <div className="home-card home-card-main"><span className="eyebrow">YOUR INVESTOR DNA</span><strong>MAVERICK</strong><small>The Independent</small><div className="home-character-mark">↗</div></div>
        <div className="home-card home-card-small"><span>RISK PROFILE</span><strong>64 / 63</strong><small>Tolerance · Capacity</small></div>
      </div>
    </section>
  ...
  if(screen==="explore") return <main className={`home-shell ${language==="fa"?"rtl":""}`}><header className="home-nav"><div className="home-brand"><Brand compact/></div><nav className="home-links"><button className="home-link" onClick={()=>setScreen("landing")}>Home</button><button className="home-link" onClick={()=>setScreen("consent")}>Investing DNA</button><button className="home-link active">Explore</button><button className="home-link">Screener</button><button className="home-link">Watchlist</button></nav><div className="home-actions"><div className="language-picker" role="group" aria-label="Language"><button className={language==="en"?"active":""} onClick={()=>setLanguage("en")}>EN</button><button className={language==="fr"?"active":""} onClick={()=>setLanguage("fr")}>FR</button><button className={language==="fa"?"active":""} onClick={()=>setLanguage("fa")}>فا</button></div></div></header><section className="coming"><div className="eyebrow">INVESTING DNA · PHASE 1</div><h1>Explore Investments</h1><p>Investment discovery is the next layer. The DNA experience is ready.</p><button className="primary" onClick={()=>setScreen("consent")}>Discover My Investor DNA →</button><button className="ghost" onClick={()=>setScreen("landing")}>Back to Home</button></section></main>;
